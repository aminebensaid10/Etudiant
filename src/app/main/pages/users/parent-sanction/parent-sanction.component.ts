...
@Component({
  selector: 'app-parent-sanction',
  templateUrl: './parent-sanction.component.html',
  styleUrls: ['./parent-sanction.component.scss']
})
export class ParentSanctionComponent implements OnInit {
